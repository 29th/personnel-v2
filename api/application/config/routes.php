...
$route['members/(:num)/discharges'] = 'discharges/index_filter/member/$1';
...
$route['units/(:any)/discharges'] = 'discharges/index_filter/unit/$1';
...
$route['discharges'] = 'discharges/index_filter';
