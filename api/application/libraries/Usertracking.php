...
class Usertracking
{
  ...
  private $needed_fields = array(array('name' => 'id', 'type' => 'int', 'primary_key' => 1, 'forge_type' => 'int', 'forge_auto_increment' => TRUE),
														...
														array('name' => 'request_method', 'type' => 'string', 'forge_type' => 'text'),
														//array('name' => 'timestamp', 'type' => 'string', 'forge_type' => 'varchar', 'forge_constraint' => '20'),
														array('name' => 'datetime', 'type' => 'string', 'forge_type' => 'datetime'),
  ...
  public function track_this()
  {
    ...
    $input_data['request_method'] = $this->CI->input->server('REQUEST_METHOD');
    //$input_data['timestamp'] = time();
    $input_data['datetime'] = format_date('now', 'mysqldatetime');
