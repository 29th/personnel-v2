...
module.exports = function initMigrationNotice() {
  if (isLegacyCookieSet()) {
    console.log("Legacy cookie set, not showing migration notice.");
    return;
  }
  ...
  dismissBtn.addEventListener("click", function() {
    // Set cookie that expires tomorrow at midnight
    var tomorrow = new Date();
    tomorrow.setDate(tomorrow.getDate() + 1);
    tomorrow.setHours(0, 0, 0, 0);
    document.cookie = 'stay_on_legacy=true; path=/; expires=' + tomorrow.toUTCString();
